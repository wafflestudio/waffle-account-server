...
object SMSCodeExpiredException : AccountException(ErrorType.SMS_CODE_EXPIRED)
object SMSCodeDoesNotExistsException : AccountException(ErrorType.SMS_CODE_NOT_FOUND)
